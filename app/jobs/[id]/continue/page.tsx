...
import JobFollowUpForm from "@/components/JobFollowUpForm";
import { toJobContext } from "@/components/job-context";
import type { ProjectConfig } from "@/lib/types";

export const dynamic = "force-dynamic";

export default async function JobContinuePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <JobFollowUpForm ctx={toJobContext(job)} unityVerify={Boolean(cfg?.unityPath)} />;
}
